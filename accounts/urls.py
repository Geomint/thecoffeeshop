...
from .views import register_account_view, login_account_view, account_profile_view, upload_product_view
...
urlpatterns = [
    ...
    url(r'product/upload', upload_product_view, name="productupload"),
]